...
- `{noop}` - no encoding password encoder. This key is handled by delegating password encoder.
...
#### Overwritting the default implementation of delegating password encoder
- We do this by defing a **bean** `PasswordEncoder`
- In that case keys like in curly brackets ` .password("{noop}guru")` have to be removed as they are handled by **delegating password encoder**. 
...
```java
 @Override
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth.inMemoryAuthentication()
                .withUser("spring")
                .password("{SSHA}cE/8qtCZZYRx1dKc2vwgSt3ctE8KLKdc7wrMBg==") //guru
                .roles("ADMIN")
                .and()
                .withUser("user")
                .password("{SSHA}Sh8eFH9rJeKJmg/L717pHHqi0McMofpsehk6cg==") //password
                .roles("USER")
                .and()
                .withUser("scott")
                .password("tiger")
...
```java
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth.inMemoryAuthentication()
                .withUser("spring")
                .password("4fef0a35c1fc8eab8fcfb70fc3798fb16daae7d25af328721542a611103c95a32b8832b069ea35fc") //guru
                .roles("ADMIN")
                .and()
                .withUser("user")
                .password("86db29e1cecf64485d1f58d5df2a99006bad098826d89a64d9a36399ef29212af8743f77ef55b291") //password
                .roles("USER")
                .and()
                .withUser("scott")
                .password("tiger")
...
```
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth.inMemoryAuthentication()
                .withUser("spring")
                .password("$2a$10$elNhnZsfpS1UvLjb8jk54OLHZ5f8e61Q0akfYUOqGLhSXhClVIJjC") //guru
                .roles("ADMIN")
                .and()
                .withUser("user")
                .password("$2a$10$KkkYIIt5KYSKAjs9kthAsOxeegFQhk9pZhUgSRfadGEpMba4At4BS") //password
                .roles("USER")
                .and()
                .withUser("scott")
                .password("tiger")
...
```
- Prefixes are used to pick up a proper encoder form Spring's class: **org.springframework.security.crypto.factory.PasswordEncoderFactories**
